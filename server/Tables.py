...
class Table:
    ...
    def count_active(self):
        return len([p for p in self.players.values() if p.is_active == True and p.is_playing == True])
    ...
    def set_player_turn(self, player_index):
        ...
        while self.ordered_players[self.player_turn % self.size()].is_playing == False or self.ordered_players[self.player_turn % self.size()].is_active == False:
    ...
    def get_prev_player(self):
        ...
        while self.ordered_players[prev_index].is_playing == False or self.ordered_players[prev_index].is_active == False:
