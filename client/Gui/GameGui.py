...
class GameGui:
    ...
    def update(self):
        ...
        if self.game_socket_handler.game_status is not None and self.game_socket_handler.new_update is True and self.game_socket_handler.game_status['winner'] is not None:
            self.handle_winner()

        if self.game_socket_handler.game_status is not None and self.game_socket_handler.new_update is True and self.game_socket_handler.game_status['winner'] is None:
